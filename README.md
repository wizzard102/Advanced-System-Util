...
the powershell scripts will temporarily give policy rights for the duration of the script that is running
...
the script can be modified or edited or added to by the end user without asking for permission it is released as freeware that anyone can modify or add to it!!! enjoy!

leave any questions in the issues section or contact me via email at stevendoane@wiz-fx.com
