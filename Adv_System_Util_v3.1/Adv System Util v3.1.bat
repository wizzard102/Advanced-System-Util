...
echo Creation Date: 04/04/19	Updated On: 11/13/25
echo Version: 3.1
...
echo 17. Windows System Configuration
echo 18. Windows Services
echo 19. Windows Group Policy Editor
echo 20. Windows Policy Reset (Removes Managed Computer)
echo.
echo App Updates
echo 21. Application Audit (#)
echo 22. ReRegister App (#)(*)
echo 23. Reinstall Built in Apps (#)(*)
echo 24. Windows Update Reset (#)(*)
echo 25. Stop/Start mDNSResponder for Bonjour (#)(*)
echo 26. Remove Windows Web Experience Pack  (#)
echo 27. Stop searchapp.exe (#)
echo.
echo Restart and Delete Files created via this batch file.
echo 28. System Restart
echo 29. Delete text files
echo.
echo NOTE: Detection of Vulnerability
echo scan has to launch before anything else above!!  
echo 30. Log4j Detection Scan (#)
echo 31. Nvidia Optimization
echo.
echo 0. Quit
...
if "%choice%"=="17" goto WSCS
if "%choice%"=="18" goto WSER
if "%choice%"=="19" goto WGRP
if "%choice%"=="20" goto WPRS
if "%choice%"=="21" goto SECA
if "%choice%"=="22" goto RAP1
if "%choice%"=="23" goto RIAP2
if "%choice%"=="24" goto WUCLU
if "%choice%"=="25" goto SSMDNS
if "%choice%"=="26" goto RWWEP
if "%choice%"=="27" goto SSAPP
if "%choice%"=="28" goto ShutDown
if "%choice%"=="29" goto DELTEXT
if "%choice%"=="30" goto Log4j
if "%choice%"=="31" goto nvdi
if "%choice%"=="0" exit
...
REM Start System Configuration
:WSCS
cls
@echo off
...
@echo off
goto Start
REM End of System Configuration
...
@echo off
goto Start
REM end windows services

REM Start grp policy editor 
:WGRP
cls
@echo off
...
REM Start Policy Reset script
:WPRS
cls
@echo on
echo Starting Windows Policy Reset script
powershell -executionpolicy Bypass -File "%~dp0scripts\policyreset\policyreset.ps1" 
pause
@echo off
goto Start
REM End of Policy Reset Script
