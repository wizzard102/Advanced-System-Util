...
echo Creation Date: 04/04/19	Updated On: 02/04/25
echo Version: 3.0
...
echo.
echo App Updates
echo 20. Application Audit (#)
echo 21. ReRegister App (#)(*)
echo 22. Reinstall Built in Apps (#)(*)
echo 23. Windows Update Reset (#)(*)
echo 24. Stop/Start mDNSResponder for Bonjour (#)(*)
echo 25. Remove Windows Web Experience Pack  (#)
echo 26. Stop searchapp.exe (#)
echo.
echo Restart and Delete Files created via this batch file.
echo 27. System Restart
echo 28. Delete text files
echo.
echo NOTE: Detection of Vulnerability
echo scan has to launch before anything else above!!  
echo 29. Log4j Detection Scan (#)
echo 30. Nvidia Optimization
echo.
echo 0. Quit
...
if "%choice%"=="20" goto SECA
if "%choice%"=="21" goto RAP1
if "%choice%"=="22" goto RIAP2
if "%choice%"=="23" goto WUCLU
if "%choice%"=="24" goto SSMDNS
if "%choice%"=="25" goto RWWEP
if "%choice%"=="26" goto SSAPP
if "%choice%"=="27" goto ShutDown
if "%choice%"=="28" goto DELTEXT
if "%choice%"=="29" goto Log4j
if "%choice%"=="30" goto nvdi
if "%choice%"=="0" exit
