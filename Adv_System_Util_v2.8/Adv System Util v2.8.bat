...
@echo off
REM Title of Window
title Welcome to the Advance System Util for windows 8/10
...
echo Creation Date: 04/04/19	Updated On: 02/27/22
echo Version: 2.8
...
echo 7. Download Windows 8 or 10 latest Image 
...
echo 17. Stop searchapp.exe (#)
echo 18. remove my phone app (#)
echo.
echo App Updates
echo 19. Application Audit (#)
echo 20. ReRegister App (#)(*)
echo 21. Reinstall Built in Apps (#)(*)
echo 22. Windows Update Reset (#)(*)
echo 23. Remove Cortana from Windows 10 (#)(*)
echo.
...
if "%choice%"=="17" goto SSAPP
if "%choice%"=="18" goto YPAR
if "%choice%"=="19" goto SECA
if "%choice%"=="20" goto RAP1
if "%choice%"=="21" goto RIAP2
if "%choice%"=="22" goto WUCLU
if "%choice%"=="23" goto RCFW
...
cls
@echo off
powershell -executionpolicy remotesigned -File "%~dp0scripts\Sec_APP\secaudit.ps1"
...
cls
@echo off
powershell -executionpolicy remotesigned -File "%~dp0scripts\HardDiskInfo\HD-Device.ps1"
pause
cls
@echo off
goto Start
...
:PID_1
 setlocal
	set ID=%g%
	if "%ID%" == "" call :Get_SID
	powershell -executionpolicy remotesigned -File "%~dp0scripts\ID_App\process.ps1"  "%ID%"
 endlocal
pause
cls
@echo off
...
:Ap1
 setlocal
	set App=%i%
	if "%App%" == "" call :Get_App
	powershell -executionpolicy remotesigned -File "%~dp0scripts\ReReg_APP\register_app.ps1" "%App%"
 endlocal
pause
cls
@echo off
...
REM Start Cortana Removal
:RCFW
cls
@echo on
powershell -executionpolicy remotesigned -File "%~dp0scripts\Rem_Cortana\RemCFW.ps1"
pause
cls
@echo off
goto Start
REM End Removal of Cortana

REM Start Your Phone Removal
:YPAR
cls
@echo on
powershell -executionpolicy remotesigned -File "%~dp0scripts\Rem_Phone\RYPA.ps1"
pause
@echo off
goto Start
REM End Your Phone App removal

REM Start reinstall all built in apps
:RIAP2
cls
@echo on
powershell -executionpolicy remotesigned -File "%~dp0scripts\ReInstall_APPS\RIAP2.ps1"
pause
@echo off
goto Start
